...
.setTitle(language("FUN_CATNAME"))
 .setAuthor(language("WEBSITE"), "https://mipper6.cf/resources/Mipper6.png", "https://mipper6.cf/bot/updates")
  ...
  .addField("`~rps`", language("RPS_DESC"))
  .addField("`~rr`", language("RR_DESC"))
...
.setTitle(`${mp3player} ${language("MUS_CATNAME")}`)
 ...
 .setAuthor(language("WEBSITE"), "https://mipper6.cf/resources/Mipper6.png", "https://mipper6.cf/bot/updates")
  ...
  .addField("`~invite`", language("INVITE_DESC"))
 ...
 .setAuthor(language("WEBSITE"), "https://mipper6.cf/resources/Mipper6.png", "https://mipper6.cf/bot/updates")
  ...
  .addField(`${language("FUN_CATNAME")}:`, `${form}~8ball${form} ${form}~cat${form} ${form}~dog${form} ${form}~quote${form} ${form}~rps${form} ${form}~rr${form} ${form}~say${form} (${language("MORE")} ~help 3)`)
  ...
  .addField(`${wrench} ${language("STH_CATNAME")}:`, `${form}~avatar${form} ${form}~emote${form} ${form}~emoteid${form} ${form}~invite${form} ${form}~lorem${form} ${form}~oir${form} ${form}~rand1-10${form} ${form}~rand1-100${form} ${form}~setlang${form} (${language("MORE")} ~help 5)`)
  .setColor("#807fff")
 .setFooter(`${language("RIGHTS")} | ${language("RELEASE")} ${version}`, "https://mipper6.cf/resources/Mipper6.png")
